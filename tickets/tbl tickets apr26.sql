...
if not exists (select null from eventsWithDates ed where eventName='Event 90 April 2026')
	insert into eventsWithDates select 'Event 90 April 2026','2026.04.23'
...
insert into #allRawTickets (eventName,eventDate,fn,ln,ticketType,rawPlayerName)
	select eventName,eventDate,fn,ln,ticketType,rawPlayerName from #bi b
		join eventsWithDates e on e.eventName='Event 90 April 2026'
...
eventName                                          
-------------------------------------------------- -----------
Event 90 April 2026                                193			--smells right
...
select ticketType,count(*) from tickets where eventName='Event 90 April 2026'--536
