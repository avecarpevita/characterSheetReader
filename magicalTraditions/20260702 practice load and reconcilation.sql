...
bulk insert #master from 'C:\characterSheetReader\magicalTraditions\masterSnapshot20260702.tsv' with(datafiletype='char',firstrow=4)

--make sure I see row 4
select top 100 * from #master where realName like 'Aaron Roth%'
--get count and smell
select count(*) from #master--73 smells right
...
bulk insert #newPractices from 'C:\characterSheetReader\magicalTraditions\practicesSnapshot20260702.tsv' with(datafiletype='char',firstrow=2, rowterminator='\n')--7

select * from #newPractices order by try_cast(timestamp as datetime)--17 looks right
...
select * from #newPractices order by [timestamp] desc--2026-06-28 22:07:40.000
...
select * from #newPractices where oocRules='Concentration (pg. 338), Parry, Dodge, Willpower and Resist (pg. 335), When Mana and Health recover naturally (pg. 133)'--Jen's practice, letting it slide
...
update #newPracticesExploded set characterId='8ZE4A' where nameInfoRaw in ('Cyren Ithilden - Alejandro (Alex) Gonzalez','Cyren Ithildin-Alejandro Gonzalez')
update #newPracticesExploded set characterId='8WN9G' where nameInfoRaw='Quincy - Trevor Ryan'
update #newPracticesExploded set characterId='79WK6' where nameInfoRaw='Alistair - Will von Muener'
update #newPracticesExploded set characterId='7VM9P' where nameInfoRaw='Stefania Nomika - Nathaneiel Goodrien'
update #newPracticesExploded set characterId='8NQQR' where nameInfoRaw='Rocco Bellamy - Dylan Yanke'
update #newPracticesExploded set characterId='8ZPMK' where nameInfoRaw='Par''thos - Ari Fitzer'
update #newPracticesExploded set characterId='7WNNQ' where nameInfoRaw='Melkora - Maddy Christensen'
update #newPracticesExploded set characterId='7WNNQ' where nameInfoRaw='Melkora - Maddy Christensen'
