...
exec applyAnchorCommitments @file='c:\anchorpoints\data\signupsDec25.tsv', @eventName='Event 87 December 2025',@doublePointSlots='SatAM'

select * into anchorChangeLog_bak20260106 from anchorChangeLog

exec applyAnchorCommitments @file='c:\anchorpoints\data\signupsJan26.tsv', @eventName='Event 88 January 2026',@doublePointSlots='SatAF|SatPM'

delete anchorChangeLog where sourcefile='c:\anchorpoints\data\signupsJan26.tsv'
...
exec applyAnchorCommitments @file='c:\anchorpoints\data\signupsFeb26.tsv', @eventName='Event 89 February 2026',@doublePointSlots='',@triplePointSlots='|SatPMCarnival'

*/
begin
set nocount on

--declare @file varchar(255)='c:\anchorpoints\data\signupsFeb26.tsv'
...
if @file not in ('c:\anchorpoints\data\signupsJan26.tsv','c:\anchorpoints\data\signupsDec25.tsv')
	begin
...
--declare @triplePointSlots  varchar(255)='SatPMCarnival'
...
create unique clustered index c on #signups(playerName,timeslot5)
--#signups where playerName like '%mari%'
